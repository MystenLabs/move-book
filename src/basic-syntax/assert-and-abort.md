...
```move
{{#include ../../samples/sources/syntax-basics/assert_abort.move:abort}}
```
...
```move
{{#include ../../samples/sources/syntax-basics/assert_abort.move:assert}}
```
...
```move
{{#include ../../samples/sources/syntax-basics/assert_abort.move:error_const}}
```
