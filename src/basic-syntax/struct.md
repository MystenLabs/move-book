...
```move
{{#include ../../samples/sources/syntax-basics/struct.move:def}}
```
...
```move
{{#include ../../samples/sources/syntax-basics/struct.move:pack}}
```
...
```move
{{#include ../../samples/sources/syntax-basics/struct.move:access}}
```
...
```move
{{#include ../../samples/sources/syntax-basics/struct.move:unpack}}
```
...
```move
{{#include ../../samples/sources/syntax-basics/struct.move:unpack_ignore}}
```
