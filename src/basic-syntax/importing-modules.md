...
{{#include ../../samples/sources/basic-syntax/importing-modules.move:module_one}}
```

File: sources/module_two.move
```move
// File: sources/module_two.move
{{#include ../../samples/sources/basic-syntax/importing-modules.move:module_two}}
```
...
```move
{{#include ../../samples/sources/basic-syntax/importing-modules.move:members}}
```
...
```move
{{#include ../../samples/sources/basic-syntax/importing-modules.move:grouped}}
```
...
```move
{{#include ../../samples/sources/basic-syntax/importing-modules.move:self}}
```
...
```move
{{#include ../../samples/sources/basic-syntax/importing-modules.move:conflict}}
```
...
```move
{{#include ../../samples/sources/basic-syntax/importing-modules.move:external}}
```
