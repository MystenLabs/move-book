 ...
 */
  var hljs=function(){"use strict";function e(t){
    ...
    ;hljs.registerLanguage("bash",e)})();/*! `ini` grammar compiled for Highlight.js 11.9.0 */
    ...
    ;hljs.registerLanguage("ini",e)})();/*! `yaml` grammar compiled for Highlight.js 11.9.0 */
...
// writing a custom language definition for highlight.js
hljs.registerLanguage('move', function(hljs) {

  var BUILTINS = {
    storage_operations: 'borrow_global_mut borrow_global exists move_to acquires',
  };
